...
<?php echo '<div class="global_msg">测试帐号:<b>test</b> 密码:<b>'.$testPwd.'</b>  测试帐号有效期为10分钟,最多同时20个人连接</div>';?>
<?php echo '<div class="global_msg">服务器IP:<b>'.$servers.'</b> L2TP共享密钥:<b>'.$secrets.'</b></div>';?>
