...
class Controller_Default_Service extends Controller_Account
{
    function actionIndex()
    {
        ...
        $this->_view['servers']=Q::ini('appini/servers');
        $this->_view['secrets']=Q::ini('appini/secrets');
        $form = Form_Common::createForm('','order');
        $testPwd = QDB::getConn()->getOne("SELECT `value` FROM `radcheck` WHERE `username` = 'test' and `attribute`='Cleartext-Password'");
